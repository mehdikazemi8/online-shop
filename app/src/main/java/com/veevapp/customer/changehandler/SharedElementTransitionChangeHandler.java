package com.veevapp.customer.changehandler;
...
import com.veevapp.customer.internal.TransitionUtils;
...
public abstract class SharedElementTransitionChangeHandler extends TransitionChangeHandler {
    ...
    @NonNull
    private final ArrayMap<String, String> sharedElementNames = new ArrayMap<>();

    @NonNull
    private final List<String> waitForTransitionNames = new ArrayList<>();
    @NonNull
    private final List<ViewParentPair> removedViews = new ArrayList<>();
    ...
    private void waitOnChildTransitionNames(@NonNull final View to, @NonNull List<View> foundViews, @NonNull final ViewTreeObserver.OnPreDrawListener parentPreDrawListener, @NonNull final OnTransitionPreparedListener onTransitionPreparedListener) {
